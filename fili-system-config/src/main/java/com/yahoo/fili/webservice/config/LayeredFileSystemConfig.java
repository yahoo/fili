...
import static com.yahoo.fili.webservice.config.ConfigMessageFormat.TOO_MANY_APPLICATION_CONFIGS;
import static com.yahoo.fili.webservice.config.ConfigMessageFormat.TOO_MANY_USER_CONFIGS;
...
public class LayeredFileSystemConfig implements SystemConfig {
    ...
    public LayeredFileSystemConfig() {
        ...
        try {
            ...
            // Application configuration defines configuration at an application level for a fili instance
