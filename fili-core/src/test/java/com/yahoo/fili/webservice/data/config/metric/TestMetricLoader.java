...
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_AREA;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_DAY_AVG_LIMBS;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_DAY_AVG_OTHER_USERS;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_DAY_AVG_USERS;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_DEPTH;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_HEIGHT;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_LIMBS;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_OTHER_USERS;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_ROW_NUM;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_USERS;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_VOLUME;
import static com.yahoo.fili.webservice.data.config.names.TestApiMetricName.A_WIDTH;
import static com.yahoo.fili.webservice.data.config.names.TestDruidMetricName.DEPTH;
import static com.yahoo.fili.webservice.data.config.names.TestDruidMetricName.HEIGHT;
import static com.yahoo.fili.webservice.data.config.names.TestDruidMetricName.LIMBS;
import static com.yahoo.fili.webservice.data.config.names.TestDruidMetricName.USERS;
import static com.yahoo.fili.webservice.data.config.names.TestDruidMetricName.WIDTH;
import static com.yahoo.fili.webservice.data.time.DefaultTimeGrain.DAY;

import com.yahoo.fili.webservice.data.config.metric.makers.AggregationAverageMaker;
import com.yahoo.fili.webservice.data.config.metric.makers.ArithmeticMaker;
import com.yahoo.fili.webservice.data.config.metric.makers.LongSumMaker;
import com.yahoo.fili.webservice.data.config.metric.makers.RowNumMaker;
import com.yahoo.fili.webservice.data.config.metric.makers.SketchCountMaker;
import com.yahoo.fili.webservice.data.metric.MetricDictionary;
import com.yahoo.fili.webservice.druid.model.postaggregation.ArithmeticPostAggregation.ArithmeticPostAggregationFunction;
