...
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.BREED;
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.COLOR;
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.MODEL;
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.OTHER;
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.SEX;
...
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.SPECIES;
import static com.yahoo.fili.webservice.data.config.names.TestDruidTableName.ALL_PETS;
import static com.yahoo.fili.webservice.data.config.names.TestDruidTableName.ALL_SHAPES;
import static com.yahoo.fili.webservice.data.config.names.TestDruidTableName.COLOR_SHAPES;
import static com.yahoo.fili.webservice.data.config.names.TestDruidTableName.COLOR_SHAPES_HOURLY;
import static com.yahoo.fili.webservice.data.config.names.TestDruidTableName.COLOR_SHAPES_MONTHLY;
import static com.yahoo.fili.webservice.data.config.names.TestDruidTableName.COLOR_SIZE_SHAPES;
import static com.yahoo.fili.webservice.data.config.names.TestDruidTableName.COLOR_SIZE_SHAPE_SHAPES;
...
import static com.yahoo.fili.webservice.data.time.DefaultTimeGrain.MONTH;
