...
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiDimensionName.BREED;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiDimensionName.COLOR;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiDimensionName.MODEL;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiDimensionName.OTHER;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiDimensionName.SEX;
...
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiDimensionName.SPECIES;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidTableName.ALL_PETS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidTableName.ALL_SHAPES;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidTableName.COLOR_SHAPES;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidTableName.COLOR_SHAPES_HOURLY;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidTableName.COLOR_SHAPES_MONTHLY;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidTableName.COLOR_SIZE_SHAPES;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidTableName.COLOR_SIZE_SHAPE_SHAPES;
...
import com.yahoo.bard.webservice.data.config.luthier.names.TestDruidMetricName;
