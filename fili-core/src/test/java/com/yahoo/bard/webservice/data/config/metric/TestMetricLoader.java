...
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_AREA;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_DAY_AVG_LIMBS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_DAY_AVG_OTHER_USERS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_DAY_AVG_USERS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_DEPTH;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_HEIGHT;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_LIMBS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_OTHER_USERS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_ROW_NUM;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_SCOPED_WIDTH;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_USERS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_VOLUME;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestApiMetricName.A_WIDTH;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidMetricName.DEPTH;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidMetricName.HEIGHT;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidMetricName.LIMBS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidMetricName.USERS;
import static com.yahoo.bard.webservice.data.config.luthier.names.TestDruidMetricName.WIDTH;
