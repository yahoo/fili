...
import static com.yahoo.fili.webservice.data.time.DefaultTimeGrain.YEAR
import static com.yahoo.fili.webservice.druid.model.DefaultQueryType.GROUP_BY
import static com.yahoo.fili.webservice.druid.model.DefaultQueryType.TIMESERIES
import static com.yahoo.fili.webservice.druid.model.DefaultQueryType.TOP_N
    ...
    def setup() {
        ...
        ["size", "shape", "color"].each { String dimensionId ->
            dimensionStore.findByApiName(dimensionId).with {
                addDimensionRow(FiliDimensionField.makeDimensionRow(it, dimensionId + "1", dimensionId + "1_desc"))
                addDimensionRow(FiliDimensionField.makeDimensionRow(it, dimensionId + "2", dimensionId + "2_desc"))
            }
        }
