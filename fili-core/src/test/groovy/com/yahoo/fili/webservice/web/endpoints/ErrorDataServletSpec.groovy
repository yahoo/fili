...
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.TOP_N
import static com.yahoo.fili.webservice.data.time.DefaultTimeGrain.DAY
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.ACCEPT_FORMAT_INVALID
...
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.FILTER_INVALID
...
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.TABLE_SCHEMA_UNDEFINED
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.TABLE_UNDEFINED
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.UNKNOWN_GRANULARITY
    ...
    def "Invalid time grain fails"() {
        ...
        String jsonFailure =
            """{
                    ...
                    "reason":"com.yahoo.fili.webservice.web.BadApiRequestException",
                    "description":"${message}",
                    "druidQuery":null,
                    "requestId": "SOME UUID"
            }"""
...
"""
    ...
    def "No matching physical table due to misconfiguration fails"() {
        ...
        """
            {"description":"${message}",
            "druidQuery":null,
            "reason":"com.yahoo.fili.webservice.table.resolver.NoMatchFoundException",
    ...
    def "Test heavy monthly query returns 507 error"() {
        ...
        [
            ...
            dimensionStore.findByApiName(dimensionId).with {
                (1..10).each { int num ->
                    addDimensionRow(FiliDimensionField.makeDimensionRow(it, dimensionId+num, dimensionId+num+"_desc"))
                }
            }
        }
