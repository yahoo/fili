...
import com.yahoo.fili.webservice.data.config.metric.makers.SketchSetOperationHelper
import com.yahoo.fili.webservice.data.config.metric.makers.SketchSetOperationMaker
...
import com.yahoo.fili.webservice.druid.model.postaggregation.ArithmeticPostAggregation
import com.yahoo.fili.webservice.druid.model.postaggregation.PostAggregation
import com.yahoo.fili.webservice.druid.model.postaggregation.SketchSetOperationPostAggFunction
import com.yahoo.fili.webservice.druid.model.postaggregation.SketchSetOperationPostAggregation
...
class SketchIntersectionReportingResources extends Specification {
    ...
    SketchIntersectionReportingResources init() {
        ...
        propertyDim.addDimensionRow(FiliDimensionField.makeDimensionRow(propertyDim, "114"))
        propertyDim.addDimensionRow(FiliDimensionField.makeDimensionRow(propertyDim, "125"))

        countryDim.addDimensionRow(FiliDimensionField.makeDimensionRow(countryDim, "US"))
        countryDim.addDimensionRow(FiliDimensionField.makeDimensionRow(countryDim, "IN"))
