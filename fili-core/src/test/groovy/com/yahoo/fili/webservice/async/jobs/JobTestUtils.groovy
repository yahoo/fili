...
package com.yahoo.fili.webservice.async.jobs

import static com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobField.JOB_TICKET
import static com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobField.QUERY
import static com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobField.STATUS
import static com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobField.DATE_CREATED
import static com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobField.DATE_UPDATED
import static com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobField.USER_ID

import com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobStatus
...
class JobTestUtils {
     ...
     * {@link com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobField} that are not keys in the metadata.
     *
