...
import static com.yahoo.fili.webservice.util.JsonSortStrategy.SORT_BOTH
...
class DimensionsServletComponentSpec extends Specification {
    ...
    def setupSpec() {
        originalMetadataCollectionNames = FiliFeatureFlag.UPDATED_METADATA_COLLECTION_NAMES.isOn()
        FiliFeatureFlag.UPDATED_METADATA_COLLECTION_NAMES.setOn(true)
        ...
        dimensionStore.findByApiName("shape").with {
            for (i in 1..35) {
                addDimensionRow(FiliDimensionField.makeDimensionRow(it, "shape"+i, "shape"+i+"Desc"))
            }
        }

        dimensionStore.findByApiName("shape").with {
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "a_distinct1", "a_distinct1_row"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "a_distinct2", "a_distinct2_row"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "unique", "unique_row"))
        }

        dimensionStore.findByApiName("model").with {
            for (i in 1..NUM_MODELS_TO_GENERATE) {
                addDimensionRow(FiliDimensionField.makeDimensionRow(it, "model"+i, "model"+i+"Desc"))
            }
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue1", "1or2or3"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue2", "1or2or3"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue3", "1or2or3"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue4", "4or5or6"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue5", "4or5or6"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue6", "4or5or6"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue7", "7or8or9"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue8", "7or8or9"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "filterValue9", "7or8or9"))
        }
    ...
    def cleanupSpec() {
        FiliFeatureFlag.UPDATED_METADATA_COLLECTION_NAMES.setOn(originalMetadataCollectionNames)
        jtb.tearDown()
    }
