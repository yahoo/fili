...
import com.yahoo.fili.webservice.web.PATCH
import com.yahoo.fili.webservice.web.endpoints.TestFilterServlet
...
class QueryParameterNormalizationFilterSpec extends Specification {
    ...
    def setupSpec() {
        ...
        context.getInitParameter("jersey.config.server.provider.packages") >> "com.yahoo.fili.webservice.web.endpoints"
    ...
    def "check valid case mapping and function finding"() {
        ...
        ClassPath.from(ClassLoader.getSystemClassLoader()).getTopLevelClasses("com.yahoo.fili.webservice.web.endpoints").each {
            classes.add(it.load())
        }
