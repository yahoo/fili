...
package com.yahoo.fili.webservice.web.exceptionmappers

import com.yahoo.fili.webservice.application.JerseyTestBinder
import com.yahoo.fili.webservice.logging.TestLogAppender
import com.yahoo.fili.webservice.web.endpoints.TestLoggingServlet
...
class LogExceptionMapperSpec extends Specification {
    ...
    def setup() {
        ...
        jtb = new JerseyTestBinder(FiliLoggingFilter.class, LogExceptionMapper.class, TestLoggingServlet.class)
        logAppender.clear()
    }
