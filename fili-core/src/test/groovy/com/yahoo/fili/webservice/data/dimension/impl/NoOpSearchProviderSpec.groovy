...
class NoOpSearchProviderSpec extends Specification {
    ...
    def setup() {
        ...
        LinkedHashSet<DimensionField> dimensionFields = [FiliDimensionField.ID, FiliDimensionField.DESC]
    ...
    def "findFilteredDimensionRows with simple filters returns expected row"() {
        ...
        DimensionRow expectedRow = FiliDimensionField.makeDimensionRow(keyValueStoreDimension, "row1Desc", "row1Desc")
    ...
    def "findFilteredDimensionRows with complex filters returns expected row"() {
        ...
        DimensionRow expectedRow1 = FiliDimensionField.makeDimensionRow(keyValueStoreDimension, "row1Desc", "row1Desc")
        DimensionRow expectedRow2 = FiliDimensionField.makeDimensionRow(keyValueStoreDimension, "row2", "row2")
        DimensionRow expectedRow3 = FiliDimensionField.makeDimensionRow(keyValueStoreDimension, "row3Name", "row3Name")
