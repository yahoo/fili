...
/**
 * This spec tests the default format for an optimized (druid native) topN data request that corresponds to
 * descending order.
 */
class TopNDataServletSpec extends BaseDataServletComponentSpec {
