...
class MultipleDimensionMultipleComplexMetricDataServletSpec extends BaseDataServletComponentSpec {
    ...
    def setup() {
        ...
        dimensionStore.findByApiName("color").with {
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "all_foo", "All foo"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "all_bar", "All bar"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "all_baz", "All baz"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "all_waz", "All waz"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "all_biz", "All biz"))
        }
        dimensionStore.findByApiName("shape").with {
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "App", "App"))
        }
    }
