...
import static com.yahoo.fili.webservice.application.AbstractBinderFactory.HEALTH_CHECK_NAME_DATASOURCE_METADATA
import static com.yahoo.fili.webservice.application.AbstractBinderFactory.HEALTH_CHECK_NAME_DIMENSION
import static com.yahoo.fili.webservice.application.AbstractBinderFactory.HEALTH_CHECK_NAME_DRUID_DIM_LOADER
import static com.yahoo.fili.webservice.application.AbstractBinderFactory.HEALTH_CHECK_VERSION
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.DRUID_CACHE
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.DRUID_CACHE_V2
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.DRUID_COORDINATOR_METADATA
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.PARTIAL_DATA
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.COLOR
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.SHAPE
import static com.yahoo.fili.webservice.data.config.names.TestApiDimensionName.SIZE
import static com.yahoo.fili.webservice.druid.client.DruidClientConfigHelper.DRUID_COORD_URL_KEY
import static com.yahoo.fili.webservice.druid.client.DruidClientConfigHelper.NON_UI_DRUID_BROKER_URL_KEY
import static com.yahoo.fili.webservice.druid.client.DruidClientConfigHelper.UI_DRUID_BROKER_URL_KEY
...
import com.yahoo.fili.webservice.config.SystemConfigException
...
import com.yahoo.fili.webservice.data.cache.TupleDataCache
...
import com.yahoo.fili.webservice.data.config.dimension.TestDimensions
...
public class AbstractBinderFactorySpec extends Specification {
    ...
    def "test configure bindings"() {
        ...
        then:
        binder != null
        3 * dc.bind({ it.advertisedContracts.contains("com.yahoo.fili.webservice.druid.client.DruidWebService") }, _)
