...
class SingleDimensionSimpleFilterDataServletSpec extends BaseDataServletComponentSpec {
    ...
    def setup() {
        ...
        dimensionStore.findByApiName("model").with {
            ...
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "Model12", "Model12Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "Model123", "Model123Desc"))
        }
    }
