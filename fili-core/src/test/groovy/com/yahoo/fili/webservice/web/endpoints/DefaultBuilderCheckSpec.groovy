...
class DefaultBuilderCheckSpec extends Specification {
    ...
    def setup() {
        ...
        dimensionStore.findByApiName("shape").with {
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "7665145", "shape1Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "52", "shape2Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "23", "shape3Desc"))
        }
    }
