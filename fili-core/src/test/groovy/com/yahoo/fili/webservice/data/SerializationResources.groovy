...
import com.yahoo.fili.webservice.data.metric.MetricColumnWithValueType
...
class SerializationResources extends Specification {
    ...
    SerializationResources init() {
        ...
        DimensionRow ageBracketRow1 = FiliDimensionField.makeDimensionRow(ageBracketDim, "1", "1")
        dimensionRows1.put(new DimensionColumn(ageBracketDim), ageBracketRow1)
        ageBracketDim.addDimensionRow(ageBracketRow1)

        DimensionRow ageBracketRow2 = FiliDimensionField.makeDimensionRow(ageBracketDim, "4", "4")
        ...
        DimensionRow gendeRow1 = FiliDimensionField.makeDimensionRow(genderDim, "m", "m")
        dimensionRows1.put(new DimensionColumn(genderDim), gendeRow1)
        genderDim.addDimensionRow(gendeRow1)

        DimensionRow gendeRow2 = FiliDimensionField.makeDimensionRow(genderDim, "f", "f")
        ...
        DimensionRow countyRow1 = FiliDimensionField.makeDimensionRow(countryDim, "US", "US")
        dimensionRows1.put(new DimensionColumn(countryDim), countyRow1)
        countryDim.addDimensionRow(countyRow1)

        DimensionRow countyRow2 = FiliDimensionField.makeDimensionRow(countryDim, "IN", "IN")
        ...
        responseContext1.put(
                ...
                [(ageBracketDim.getApiName()): [FiliDimensionField.ID] as Set]
        )
    ...
    String getSerializedPreResponse(){
        """
            {
              "responseContext": "[\\"com.yahoo.fili.webservice.web.responseprocessors.ResponseContext\\",{\\"randomHeader\\":\\"someHeader\\",\\"missingIntervals\\":[\\"java.util.ArrayList\\",[\\"a\\",\\"b\\",\\"c\\",[\\"java.util.ArrayList\\",[[\\"org.joda.time.Interval\\",\\"2011-02-02T07:00:00.000Z/2011-02-03T10:15:00.000Z\\"]]],[\\"java.math.BigDecimal\\",100]]]}]",
              "resultSet": {
                "results": [
                  {
                    "dimensionValues": {
    ...
    String getSerializedReponseContext1() {
        """["com.yahoo.fili.webservice.web.responseprocessors.ResponseContext",{"randomHeader":"someHeader","apiMetricColumnNames":["java.util.LinkedHashSet",["metric1, metric2"]],"requestedApiDimensionFields":["java.util.LinkedHashMap",{"ageBracket":["java.util.LinkedHashSet",[["com.yahoo.fili.webservice.data.dimension.FiliDimensionField",{"name":"id","description":"Dimension ID"}]]]}]}]"""
    }
}
