...
class MultipleDimensionSingleSimpleMetricDataServletSpec extends BaseDataServletComponentSpec {
    ...
    def setup() {
        ...
        dimensionStore.findByApiName("shape").with {
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "shape1", "shape1Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "shape2", "shape2Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "shape3", "shape3Desc"))
        }
        dimensionStore.findByApiName("size").with {
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "size1", "size1Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "size2", "size2Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "size3", "size3Desc"))
        }
    }
