...
class DimensionCacheLoaderServletSpec extends Specification {
    ...
    def setup() {
        ...
        dimensionGenderFields = [FiliDimensionField.ID, FiliDimensionField.DESC] as LinkedHashSet<DimensionField>
        dimensionUserCountryFields = [
                FiliDimensionField.ID,
                FiliDimensionField.DESC,
                FiliDimensionField.FIELD1,
                FiliDimensionField.FIELD2
        ...
        dimensionRowMale = FiliDimensionField.makeDimensionRow(dimensionGender, "m", "male")
        dimensionRowFemale = FiliDimensionField.makeDimensionRow(dimensionGender, "f", "female")
        ...
        dimensionRowUSA = FiliDimensionField.makeDimensionRow(dimensionUserCountry, "usa", "USA", "usa1", "usa2")
        dimensionRowIndia = FiliDimensionField.makeDimensionRow(dimensionUserCountry, "ind", "India", "ind1", "ind2")
    ...
    def "Check addReplaceDimensionRows for dimension cache loader endpoint"() {
        ...
        expectedDimensionRowsUserCountry << FiliDimensionField.makeDimensionRow(
