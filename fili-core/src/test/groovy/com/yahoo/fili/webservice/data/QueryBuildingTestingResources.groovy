...
import static com.yahoo.fili.webservice.data.time.DefaultTimeGrain.WEEK
import static org.joda.time.DateTimeZone.UTC

import com.yahoo.fili.webservice.data.config.dimension.DimensionConfig
import com.yahoo.fili.webservice.data.config.dimension.TestLookupDimensions
import com.yahoo.fili.webservice.data.config.dimension.TestRegisteredLookupDimensions
...
import com.yahoo.fili.webservice.data.metric.LogicalMetricColumn
...
public class QueryBuildingTestingResources {
    ...
    public QueryBuildingTestingResources init() {
        ...
        d2.addAllDimensionRows(ages.collect { FiliDimensionField.makeDimensionRow(d2, it.key, it.value) } as Set)
        ...
        d3.addAllDimensionRows(ages.collect { FiliDimensionField.makeDimensionRow(d3, it.key, it.value) } as Set)
