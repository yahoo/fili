...
import com.yahoo.fili.webservice.logging.TestLogAppender
import com.yahoo.fili.webservice.web.LoggingTestUtils
...
/**
 * Uses TestFilterServlet to validate FiliLoggingFilter works correctly
 */
@Timeout(30)
// Fail test if hangs
class LogFilterSpec extends Specification {
    ...
    def setup() {
        ...
        jtb = new JerseyTestBinder(FiliLoggingFilter.class, TestFilterServlet.class)
        logAppender.clear()
    }
