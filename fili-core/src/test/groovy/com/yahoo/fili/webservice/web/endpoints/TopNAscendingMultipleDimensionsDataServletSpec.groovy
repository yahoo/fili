...
/**
 * This spec tests the format for a topN data request with multiple dimensions that corresponds to ascending order.
 */
class TopNAscendingMultipleDimensionsDataServletSpec extends BaseDataServletComponentSpec {
    ...
    def setup() {
        ...
        dimensionStore.findByApiName("model").with {
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "Model1", "Model1Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "Model2", "Model2Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "Model3", "Model3Desc"))
        }
        dimensionStore.findByApiName("color").with {
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "color1", "color1Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "color2", "color2Desc"))
            addDimensionRow(FiliDimensionField.makeDimensionRow(it, "color3", "color3Desc"))
        }
    }
