...
import static com.yahoo.fili.webservice.druid.model.postaggregation.PostAggregation.DefaultPostAggregationType
...
class EnumUtilsSpec extends Specification {
    ...
    def "check missing forKey"(){
        ...
        e.getMessage().toString() == """Not an alternate key for class com.yahoo.fili.webservice.util.EnumUtilsSpec\$TestEnum: THIS_IS_A_TEST"""
    }
}
