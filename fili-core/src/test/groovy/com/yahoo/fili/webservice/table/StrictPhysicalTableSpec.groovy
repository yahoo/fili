...
class StrictPhysicalTableSpec extends Specification {
    ...
    def setupSpec() {
        dimension = new KeyValueStoreDimension("dimensionOne", null, [FiliDimensionField.ID] as LinkedHashSet, MapStoreManager.getInstance("dimension"), ScanSearchProviderManager.getInstance("apiProduct"))
