...
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.DATA_FILTER_SUBSTRING_OPERATIONS
...
class DataApiRequestFilterSpec extends Specification {
    ...
    def setup() {
        LinkedHashSet dimensionFields = [FiliDimensionField.ID, FiliDimensionField.DESC]
