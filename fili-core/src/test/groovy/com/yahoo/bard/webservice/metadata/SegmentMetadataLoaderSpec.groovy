    ...
    "2012-01-01T00:00:00.000Z/2013-12-27T00:00:00.000Z":
        {
            ...
            "metrics":
                [
                    "nw_sketch",
                    "bcookie_no_yuid_sketch",
                    "yuid_sketch",
                    "sids_sketch",
                    "other_clicks",
                    "ad_clicks",
                    "bcookie_with_yuid_sketch",
                    "interactions",
                    "additive_page_views",
                    "other_page_views",
                    "timespent"
...
"""
    ...
    def setup() {
        ...
        ["tablename"].each {
            PhysicalTable table = new PhysicalTable(it, WEEK)
    ...
    def "Test segment metadata can deserialize JSON correctly"() {
        ...
        final expectDimensionDict = dimensionDict
        ...
        capture.getDimensionIntervals().containsKey("product_family")
        capture.getDimensionIntervals().get("product_family").size() == 1
        capture.getMetricIntervals().get("nw_sketch").size() == 2
    }
