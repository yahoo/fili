...
class TemplateDruidQuerySpec extends Specification {
    ...
    def "verify query.isNested()"() {
        ...
        expect:
            ...
            q2.isNested() == true
            q3.isNested() == true
            q2.getNestedQuery().isNested() == false
            q3.getNestedQuery().isNested() == true
            q3.getNestedQuery().getNestedQuery().isNested() == false
    ...
    def "verify query.nest()"() {
        ...
        expect:
            ...
            q2.getNestedQuery() != null
            q2.getNestedQuery().getAggregations().sort() == [agg1, agg2].sort()
            q2.getNestedQuery().getPostAggregations().isEmpty()
    }
    ...
    def "verify q1.merge(q2) equals merged"() {
         ...
         expect:
            ...
            merged.depth() == 2
            merged.getNestedQuery().getAggregations().sort() == [q2_agg1, nested_agg1].sort()
            merged.getNestedQuery().getPostAggregations().sort() == [nested_postagg1]
