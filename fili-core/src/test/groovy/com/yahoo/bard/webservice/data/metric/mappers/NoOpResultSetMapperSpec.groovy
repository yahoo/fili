...
class NoOpResultSetMapperSpec extends Specification {
    ...
    def "check NoOpResultSetMapper"(){
        ...
        Map<DimensionColumn, DimensionRow> dimensionRows1 = ["dimName1", "dimName2"].collectEntries {
            DimensionColumn dc = new DimensionColumn(new KeyValueStoreDimension(it, it, it, dimensionFields, MapStoreManager.getInstance(it), ScanSearchProviderManager.getInstance(it)))
