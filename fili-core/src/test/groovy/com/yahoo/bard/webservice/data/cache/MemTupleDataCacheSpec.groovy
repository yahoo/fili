...
class MemTupleDataCacheSpec extends Specification {
    ...
    int defaultCheckSum = -1234
    int expectedCheckSum = -1234
    @Shared TupleDataCache<String, Integer, String> cache
    ...
    def setup() {
        ...
        BaseDataServletComponentSpec.populatePhysicalTableCacheIntervals(jtb, interval)
        cache = (TupleDataCache<String, Integer, String>) jtb.dataCache
    }
    ...
    def "cache set and get #key1 and #key2"() {
        ...
        "key"         | "key2"        | 1234      | -8765     | "value"        | "value2"
        "key1\ufe01@" | "key2\ufe02@" | -4321     | 5678      | "value\ufe01#" | "value\ufe02#"
    }
    ...
    def "cache throws #exception.simpleName because #reason"() {
        ...
        null | 0        | null  | NullPointerException  | "cache key is null"
    }
