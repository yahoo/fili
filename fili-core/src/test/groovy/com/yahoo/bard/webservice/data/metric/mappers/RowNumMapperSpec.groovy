...
class RowNumMapperSpec extends Specification {
    ...
    def "check RowNumMapper"(){
        ...
        Dimension d1 = new KeyValueStoreDimension("d1", "d1-druid", "d1-desc", dimensionFields, MapStoreManager.getInstance("d1"), ScanSearchProviderManager.getInstance("d1"))
        Dimension d2 = new KeyValueStoreDimension("d2", "d2-druid", "d2-desc", dimensionFields, MapStoreManager.getInstance("d2"), ScanSearchProviderManager.getInstance("d2"))
