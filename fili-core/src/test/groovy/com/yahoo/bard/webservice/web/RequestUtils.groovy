...
class RequestUtils {
    ...
    static GroupByQuery buildGroupByQuery(
        ...
        DataSource<GroupByQuery> dataSource = new TableDataSource<GroupByQuery>(dataSourceName)
        List dimensions = []
        List intervals = []
        new GroupByQuery(
                dataSource,
    ...
    static TopNQuery buildTopNQuery(
        ...
        DataSource<TopNQuery> dataSource = new TableDataSource<TopNQuery>(dataSourceName)
        List intervals = []
        new TopNQuery(
                dataSource,
                granularity,
    ...
    static TimeSeriesQuery buildTimeSeriesQuery(
        ...
        DataSource<TimeSeriesQuery> dataSource = new TableDataSource<TimeSeriesQuery>(dataSourceName)
        List intervals = []
        new TimeSeriesQuery(
                dataSource,
                granularity,
