...
class PartitionAvailabilitySpec extends Specification{
    ...
    def "test missing intervals properly created for #interval interval and #desc"() {
        ...
        new DateTime(2014,1,1,0,0)      |   new DateTime(2018,1,1,0,0)  |   ["2014-01-01/2016-01-01"]                               ||   ["2016-01-01/2018-01-01"]                                                                                              |   "unbroken, of start to middle"                |   "concrete beginning and end"
        new DateTime(2014,1,1,0,0)      |   new DateTime(2018,1,1,0,0)  |   ["2016-01-01/2018-01-01"]                               ||   ["2014-01-01/2016-01-01"]                                                                                              |   "unbroken, of middle to end"                  |   "concrete beginning and end"
