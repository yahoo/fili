...
class GroupByQuerySpec extends Specification {
    ...
    GroupByQuery defaultQuery(Map vars) {
        ...
        vars.dataSource = vars.dataSource ?: new TableDataSource<GroupByQuery>("table_name")
    ...
    def "check dimensions serialization"() {
        ...
        String queryString2 = stringQuery(dimensions: """["locale"]""")
        String queryString3 = stringQuery(dimensions: """["locale","platform","product"]""")
    ...
    def "check dataSource serialization"() {
        //non nested query
        DataSource<GroupByQuery> ds1 = new TableDataSource<GroupByQuery>("table_name")
        GroupByQuery dq1 = defaultQuery(dataSource: ds1)

        //nested query
        DataSource<GroupByQuery> ds2 = new QueryDataSource<GroupByQuery>(dq1)
    ...
    def "Check innermost query injection"() {
        setup:
        TableDataSource<GroupByQuery> inner1 = new TableDataSource<GroupByQuery>("inner1")
        TableDataSource<GroupByQuery> inner2 = new TableDataSource<GroupByQuery>("inner2")
        GroupByQuery dq1 = defaultQuery(dataSource: inner1)
        DataSource<GroupByQuery> outer1 = new QueryDataSource<>(dq1)
    ...
    def "Check all intervals injection"() {
        ...
        and: "A nested query"
        TableDataSource<GroupByQuery> table = new TableDataSource<GroupByQuery>("inner1")
