...
class FlagFromTagDimensionToDimensionSpecSpec extends Specification {
    ...
    def setup() {
        ...
        LogicalMetricImpl lm1 = new LogicalMetricImpl(
                resources.simpleTemplateQuery,
                new NoOpResultSetMapper(),
                new LogicalMetricInfo("lm1")
        )
    ...
    def "Flag from tag dimension pushes extraction and transformation to innermost query when nesting"() {
        setup:
        LogicalMetricImpl nestedLogicalMetric = new LogicalMetricImpl(
                resources.simpleNestedTemplateQuery,
                new NoOpResultSetMapper(),
                new LogicalMetricInfo("lm1")
        )
