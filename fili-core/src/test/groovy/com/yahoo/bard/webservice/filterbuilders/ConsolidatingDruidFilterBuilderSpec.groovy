...
class ConsolidatingDruidFilterBuilderSpec extends Specification {
    ...
    def "#filterString is a #filterType-filter on #selectorDimension, with #orFilterSize or-clauses of selectors"() {
        ...
        selectorFilter.dimension.getDruidName() == selectorDimension
        selectorFilter.getValue() == value

        where:
        filterString                      | filterType | orFilterSize   | selectIndex | selectorDimension | value
        "ageBracket|id-eq[1]"             | SELECTOR   | 1              | 0           | "age_bracket"     | "1"
        "ageBracket|id-in[1]"             | SELECTOR   | 1              | 0           | "age_bracket"     | "1"
        "ageBracket|id-startswith[1]"     | SELECTOR   | 1              | 0           | "age_bracket"     | "1"
        "ageBracket|id-contains[1]"       | SELECTOR   | 1              | 0           | "age_bracket"     | "1"
        "ageBracket|id-notin[1]"          | NOT        | 1              | 0           | "age_bracket"     | "1"
        "ageBracket|id-eq[1,2,4]"         | OR         | 3              | 2           | "age_bracket"     | "4"
        "ageBracket|desc-eq[11-14,14-29]" | OR         | 2              | 1           | "age_bracket"     | "3"
    }
