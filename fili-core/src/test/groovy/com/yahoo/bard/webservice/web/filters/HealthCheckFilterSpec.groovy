...
class HealthCheckFilterSpec extends Specification {
    ...
    static originalVersionKey = systemConfig.getStringProperty(VersionHealthCheck.VERSION_KEY)
    ...
    def "Healthly version check passes"() {
        ...
        healthCheck.getMessage() == "1.2.3.4"
    ...
    def "Unset version check fails"() {
        ...
        registry.register(registeredName, new VersionHealthCheck(systemConfig.getPackageVariableName("version")))
