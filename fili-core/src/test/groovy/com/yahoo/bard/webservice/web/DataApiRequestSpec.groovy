...
class DataApiRequestSpec extends Specification {
    ...
    StandardTimeContext timeContext = new StandardTimeContext()
    ...
    def "check valid granularity name #name parses to granularity #expected"() {
        expect:
        new DataApiRequest().generateGranularity(name, timeContext) == expected
    ...
    def "check invalid granularity creates error"() {
        ...
        when:
        new DataApiRequest().generateGranularity(timeGrainName, timeContext)
    ...
    def "check weekly granularity has the expected alignment description"() {
        ...
        Granularity<?> granularity = new DataApiRequest().generateGranularity("week", new StandardTimeContext())
