...
class ThetaSketchSetOperationHelperSpec extends Specification {
    ...
    def setup() {
        ...
        filteredAggregationList = new ArrayList<>(resources.bcookieNoYuidFilteredAggregationSet)
        filteredAggregationList.addAll(resources.bcookieRegBcookiesFilteredAggregationSet)
