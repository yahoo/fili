...
class TemplateDruidQueryMergerSpec extends Specification {
    ...
    def "Verify merger.merge"() {
        setup:
            ...
            LogicalMetricImpl m1 = new LogicalMetricImpl(q1, null, new LogicalMetricInfo("Metric1"))
            LogicalMetricImpl m2 = new LogicalMetricImpl(q2, null, new LogicalMetricInfo("Metric2"))
            LogicalMetricImpl m3 = new LogicalMetricImpl(q3, null, new LogicalMetricInfo("Metric3"))
