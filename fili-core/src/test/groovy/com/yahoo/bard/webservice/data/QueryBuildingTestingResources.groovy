...
public class QueryBuildingTestingResources {
    ...
    public QueryBuildingTestingResources() {
        ...
        t1h = new PhysicalTable("table1h", utcHour)
        t1d = new PhysicalTable("table1d", utcDay)
        t1hShort = new PhysicalTable("table1Short", utcHour)

        t2h = new PhysicalTable("table2", utcHour)
        t3d = new PhysicalTable("table3", utcDay)

        tna1236d = new PhysicalTable("tableNA1236", utcDay)
        tna1237d = new PhysicalTable("tableNA1237", utcDay)
        tna167d = new PhysicalTable("tableNA167", utcDay)
        tna267d = new PhysicalTable("tableNA267", utcDay)

        t4h1 = new PhysicalTable("table4h1", utcHour)
        t4h2 = new PhysicalTable("table4h2", utcHour)
        t4d1 = new PhysicalTable("table4d1", utcDay)
        t4d2 = new PhysicalTable("table4d2", utcDay)
    ...
    def setupPartialData() {
        ...
        emptyFirst = new PhysicalTable("emptyFirst", MONTH)
        emptyLast = new PhysicalTable("emptyLast", MONTH)
        partialSecond = new PhysicalTable("partialSecond", MONTH)
        wholeThird = new PhysicalTable("wholeThird", MONTH)
