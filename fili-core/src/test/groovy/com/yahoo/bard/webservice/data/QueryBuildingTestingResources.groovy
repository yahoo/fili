...
public class QueryBuildingTestingResources extends Specification {

    public Dimension d1, d2, d3, d4, d5, d6, d7, d8, d9, d10
    ...
    public QueryBuildingTestingResources init() {
        ...
        d8 = new LookupDimension((LookupDimensionConfig) dimConfig.getAt(0))
        d9 = new LookupDimension((LookupDimensionConfig) dimConfig.getAt(1))
        d10 = new LookupDimension((LookupDimensionConfig) dimConfig.getAt(2))
        ...
        t5h = new ConcretePhysicalTable("table5d", utcHour, [d8, d9, d10, m1].collect{toColumn(it)}.toSet(), [:])
