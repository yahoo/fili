...
"""
    ...
    def "Test heavy monthly query returns 507 error"() {
        setup:
        int statusCode = 507
        String reason = ErrorMessageFormat.WEIGHT_CHECK_FAILED.format()
        String description = ErrorMessageFormat.WEIGHT_CHECK_FAILED.logFormat(30000, 20000)
    ...
    def "Test heavy daily query produces 507 error"() {
        ...
        int statusCode = 507
        String reason = ErrorMessageFormat.WEIGHT_CHECK_FAILED.format()
        String description = ErrorMessageFormat.WEIGHT_CHECK_FAILED.logFormat(429820, 100000)
        String statusName = "507"
        String expectedJson = buildFailureJson( statusCode, statusName, reason, description )
