...
class ApiFilterSpec extends Specification {
    ...
    def setup() {
        ...
        dimension1 = new KeyValueStoreDimension("dimension1", "druidOne", "dimension1-description", dimensionFields, MapStoreManager.getInstance("dimension1"), ScanSearchProviderManager.getInstance("dimension1"))
        dimension1.setLastUpdated(new DateTime(10000))
        dimension2 = new KeyValueStoreDimension("dimension2", "druidTwo", "dimension2-description", dimensionFields, MapStoreManager.getInstance("dimension2"), ScanSearchProviderManager.getInstance("dimension2"))
        dimension2.setLastUpdated(new DateTime(10001))
        dimension3 = new KeyValueStoreDimension("dimension3", "druidThree", "dimension3-description", dimensionFields, MapStoreManager.getInstance("dimension3"), ScanSearchProviderManager.getInstance("dimension3"))
