...
public class PartialDataResultSetMapper extends ResultSetMapper {
    ...
    public boolean equals(Object o) {
        ...
        return !(missingIntervals != null ? !missingIntervals.equals(that.missingIntervals) : that.missingIntervals != null);
    }
    //CHECKSTYLE:ON
    ...
    public int hashCode() {
        ...
        result = 31 * result + (missingIntervals != null ? missingIntervals.hashCode() : 0);
        return result;
    }
}
