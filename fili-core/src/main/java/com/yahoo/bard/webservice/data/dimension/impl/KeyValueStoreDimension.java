...
public class KeyValueStoreDimension implements Dimension {
     ...
     * @param druidName  Druid column name of the dimension
    ...
    public void addAllDimensionRows(Set<DimensionRow> dimensionRows) {
        ...
        Map<String, String> storeRows = new HashMap<>(dimensionRows.size());
        Map<String, Pair<DimensionRow, DimensionRow>> indexRows = new HashMap<>(dimensionRows.size());
    ...
    public DimensionRow parseDimensionRow(Map<String, String> fieldNameValueMap) {
        // This rewrite need to be removed once description is normalized in digits
    ...
    public boolean equals(Object o) {
        ...
        // CHECKSTYLE:OFF
        if (dimensionFields != null ? !dimensionFields.equals(that.dimensionFields) : that.dimensionFields != null) { return false; }
        // CHECKSTYLE:ON
        if (druidName != null ? !druidName.equals(that.druidName) : that.druidName != null) { return false; }
        return true;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (druidName != null ? druidName.hashCode() : 0);
        result = 31 * result + (description != null ? description.hashCode() : 0);
        result = 31 * result + (dimensionFields != null ? dimensionFields.hashCode() : 0);
        return result;
    }
