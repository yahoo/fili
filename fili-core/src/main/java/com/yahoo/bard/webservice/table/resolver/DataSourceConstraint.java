...
public class DataSourceConstraint {
    ...
    protected DataSourceConstraint(
        ...
        this.filterDimensions = Collections.unmodifiableSet(apiFilters.keySet());
     ...
     * {@link #DataSourceConstraint(Set, Set, Set, ApiFilters)} instead, which saves caller argument-passing
     * efforts.
     */
    @Deprecated
    protected DataSourceConstraint(
