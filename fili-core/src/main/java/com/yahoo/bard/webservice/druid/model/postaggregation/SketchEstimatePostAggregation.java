...
public class SketchEstimatePostAggregation extends FuzzySetPostAggregation {
    ...
    public SketchEstimatePostAggregation withName(String name) {
        return new SketchEstimatePostAggregation(name, this.getField());
    }

    @Override
    public SketchEstimatePostAggregation withField(FieldAccessorPostAggregation field) {
        return new SketchEstimatePostAggregation(this.getName(), field);
    }
    ...
    public SketchEstimatePostAggregation withFields(List<PostAggregation> fields) {
        ...
        return new SketchEstimatePostAggregation(this.getName(), fields.get(0));
    }
}
