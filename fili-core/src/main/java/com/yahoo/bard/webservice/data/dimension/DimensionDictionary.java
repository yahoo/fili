...
public class DimensionDictionary {
    ...
    private final LinkedHashMap<String, Dimension> druidNameToDimension;
    ...
    public DimensionDictionary() {
        ...
        druidNameToDimension = new LinkedHashMap<>();
    }
     ...
     * @return a dimension - returns the first one found (if exists)
     */
    ...
    /**
     * Find a Dimension given a dimension druid name
     *
     * @param dimensionName  API name to search
     * @return a dimension - returns the first one found (if exists)
     */
    public Dimension findByDruidName(String dimensionName) {
        return druidNameToDimension.get(dimensionName);
    }
    ...
    public boolean add(Dimension dimension) {
        ...
        druidNameToDimension.put(dimension.getDruidName(), dimension);
    ...
    public String toString() {
        return "Dimension Dictionary: " + apiNameToDimension + "\n" + druidNameToDimension;
    }

    @Override
    public int hashCode() {
        return apiNameToDimension.hashCode();
    }
