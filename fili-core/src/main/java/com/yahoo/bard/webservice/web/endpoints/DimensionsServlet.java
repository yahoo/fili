...
public class DimensionsServlet extends EndpointServlet {
    ...
    @Inject
    public DimensionsServlet(DimensionDictionary dimensionDictionary,
    ...
    public Response getDimensionRows(
        ...
        try {
            ...
            Collection<DimensionRow> filteredDimRows = !apiRequest.getFilters().isEmpty() ?
                apiRequest.getDimension().getSearchProvider().findFilteredDimensionRows(apiRequest.getFilters()) :
                apiRequest.getDimension().getSearchProvider().findAllOrderedDimensionRows();

            Stream<Map<String, String>> rows = apiRequest.getPage(filteredDimRows)
     ...
     */
    public static Set<Map<String, String>> getDimensionListSummaryView (
     ...
     */
    public static Map<String, String> getDimensionSummaryView(Dimension dimension, final UriInfo uriInfo) {
        ...
        resultRow.put("cardinality", String.valueOf(dimension.getCardinality()));
        return resultRow;
    }
