...
public class DruidQueryBuilder {
    ...
    protected GroupByQuery buildGroupByQuery(
        ...
        if (!template.isNested()) {
            ...
            DataSource dataSource = new TableDataSource(table.getName());
        ...
        TemplateDruidQuery nestedQuery = template.getNestedQuery();
    ...
    boolean canOptimizeTopN(DataApiRequest apiRequest, TemplateDruidQuery tdq) {
    ...
    boolean canOptimizeTimeSeries(DataApiRequest apiRequest, TemplateDruidQuery tdq) {
