 ...
 */
@Singleton
public class DefaultPermissivePhysicalTableResolver extends BasePhysicalTableResolver {
     ...
     */
    @Inject
    public DefaultPermissivePhysicalTableResolver(
    ...
    public BinaryOperator<PhysicalTable> getBetterTableOperator(QueryPlanningConstraint requestConstraint) {
        ...
        if (BardFeatureFlag.PARTIAL_DATA.isOn() || BardFeatureFlag.PARTIAL_DATA_QUERY_OPTIMIZATION.isOn()) {
            ...
            comparators.add(new PermissivePartialTimeComparator(requestConstraint, partialDataHandler));
        }
