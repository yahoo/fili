...
public class DruidSearchQuery extends AbstractDruidFactQuery<DruidSearchQuery> {
    ...
    public DruidSearchQuery withDataSource(DataSource dataSource) {
        return new DruidSearchQuery(dataSource, granularity, filter, intervals, searchDimensions, query, sort, limit, context, false);
    }
    ...
    public DruidSearchQuery withGranularity(Granularity granularity) {
        return new DruidSearchQuery(getDataSource(), granularity, filter, intervals, searchDimensions, query, sort, limit, context, false);
    }
