...
public interface MetricsFilterSetBuilder {
     ...
     * duplicate metrics
     */
    void validateDuplicateMetrics(JSONArray metricsJsonArray);
     ...
     * @throws com.yahoo.bard.webservice.data.dimension.DimensionRowNotFoundException if the dimension mentioned in the
     ...
     * the nested query. Eg: bcookie --&gt; bcookie-dim1334dim2445
     *
     ...
     * Eg: bcookie --&gt; bcookie-dim1334dim2445
     ...
     * @throws com.yahoo.bard.webservice.data.dimension.DimensionRowNotFoundException if the dimension row in the metric
     * filter is not found.
     */
