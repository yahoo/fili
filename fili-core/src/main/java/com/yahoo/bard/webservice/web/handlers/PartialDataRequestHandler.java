...
public class PartialDataRequestHandler implements DataRequestHandler {
    ...
    public boolean handleRequest(
        ...
        SimplifiedIntervalList missingIntervals = partialDataHandler.findMissingRequestTimeGrainIntervals(
                request,
                druidQuery,
                physicalTables
        );
     ...
     */
    public static SimplifiedIntervalList getPartialIntervalsWithDefault(Map<String, Object> context) {
