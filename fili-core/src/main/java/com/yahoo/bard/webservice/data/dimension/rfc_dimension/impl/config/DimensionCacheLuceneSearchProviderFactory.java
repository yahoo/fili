...
// Replaces: LuceneSearchProviderManager

/**
 *
 */
public class DimensionCacheLuceneSearchProviderFactory implements SearchProviderFactory {
     ...
     */
    @Override
    public synchronized LuceneSearchProvider build(String providerName) {
     ...
     */
    @Override
    public synchronized void removeInstance(String providerName) {
