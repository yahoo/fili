...
public class ThetaSketchEstimatePostAggregation extends FuzzySetPostAggregation {
    ...
    public ThetaSketchEstimatePostAggregation withName(String name) {
        return new ThetaSketchEstimatePostAggregation(name, this.getField());
    }

    @Override
    public ThetaSketchEstimatePostAggregation withField(FieldAccessorPostAggregation field) {
        return new ThetaSketchEstimatePostAggregation(this.getName(), field);
    }
    ...
    public ThetaSketchEstimatePostAggregation withFields(List<PostAggregation> fields) {
        ...
        return new ThetaSketchEstimatePostAggregation(this.getName(), fields.get(0));
    }
}
