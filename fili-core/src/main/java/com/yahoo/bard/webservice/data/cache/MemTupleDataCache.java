...
public class MemTupleDataCache<V extends Serializable>
        extends MemDataCache<TupleDataCache.DataEntry<String, Integer, V>>
        implements TupleDataCache<String, Integer, V> {
    ...
    public V getDataValue(String key) {
        TupleDataCache.DataEntry<String, Integer, V> result = get(key);
    ...
    @Override
    public TupleDataCache.DataEntry<String, Integer, V> get(String key) {
        return super.get(hash(key));
    }

    @Override
    public boolean set(String key, Integer meta, V value) {
    ...
    public static class DataEntry<V extends Serializable>
            implements TupleDataCache.DataEntry<String, Integer, V>, Serializable {
         ...
         */
        public DataEntry(String key,  Integer meta, V value) {
            this.key = key;
            this.checkSum = meta;
            this.value = value;
        }
