...
public class DefaultingVolatileIntervalsService implements VolatileIntervalsService {
    ...
    @Override
    public SimplifiedIntervalList getVolatileIntervals(DruidAggregationQuery<?> query, PhysicalTable factSource) {
        Granularity granularity = query.getGranularity();

        SimplifiedIntervalList simplifiedRequestedIntervals = new SimplifiedIntervalList(query.getIntervals());
        SimplifiedIntervalList volatileIntervals = IntervalUtils.collectBucketedIntervalsIntersectingIntervalList(
                ...
                simplifiedRequestedIntervals,
                granularity
        );
        if (granularity instanceof AllGranularity && !volatileIntervals.isEmpty()) {
            volatileIntervals = simplifiedRequestedIntervals;
        }
