...
public class ApiFilter {
    ...
    public boolean equals(Object o) {
        ...
        if (dimension != null ? !dimension.equals(apiFilter.dimension) : apiFilter.dimension != null) { return false; }
        if (dimensionField != apiFilter.dimensionField) { return false; }
        if (operation != apiFilter.operation) { return false; }
        if (values != null ? !values.equals(apiFilter.values) : apiFilter.values != null) { return false; }
    ...
    public int hashCode() {
        ...
        result = 31 * result + (dimensionField != null ? dimensionField.hashCode() : 0);
