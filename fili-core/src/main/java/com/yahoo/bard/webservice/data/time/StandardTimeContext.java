...
/**
 * Standard time context implements a time grain dictionary, as well as factory methods to dynamically build zoned
 * time grains.
 */
public class StandardTimeContext implements TimeContext {

    private final Map<String, Granularity> namedGrains;

    public StandardTimeContext() {
