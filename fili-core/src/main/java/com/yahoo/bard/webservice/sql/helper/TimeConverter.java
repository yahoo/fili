...
public class TimeConverter {
    ...
    /**
     * Gets the {@link DefaultTimeGrain} given a {@link Granularity}.
     *
     * @param granularity  The granularity to find the timegrain of.
     *
     * @return the {@link DefaultTimeGrain} for the given granularity.
     */
    private static DefaultTimeGrain getDefaultTimeGrain(Granularity granularity) {
        // todo possibly include all granularity
