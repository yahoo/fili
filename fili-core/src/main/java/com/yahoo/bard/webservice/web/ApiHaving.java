...
public class ApiHaving {
    ...
    public boolean equals(Object o) {
        ...
        if (metric != null ? !metric.equals(apiHaving.metric) : apiHaving.metric != null) { return false; }
        if (operation != apiHaving.operation) { return false; }
        if (values != null ? !values.equals(apiHaving.values) : apiHaving.values != null) { return false; }
