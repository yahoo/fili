...
import com.yahoo.bard.webservice.web.apirequest.mapimpl.MapRequestUtil;
 ...
 */
public class JobsApiRequestBeanImpl extends ApiRequestMapImpl implements JobsApiRequest {
    private static final Logger LOG = LoggerFactory.getLogger(JobsApiRequestBeanImpl.class);
