...
public class Schema {
    ...
    public boolean equals(Object o) {
        ...
        if (columns != null ? !columns.equals(schema.columns) : schema.columns != null) { return false; }
        return granularity.equals(schema.granularity);
    }

    @Override
    public int hashCode() {
        int result = granularity != null ? granularity.hashCode() : 0;
