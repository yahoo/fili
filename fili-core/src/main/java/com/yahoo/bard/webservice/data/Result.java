...
public class Result {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((dimensionRows == null) ? 0 : dimensionRows.hashCode());
        result = prime * result + ((metricValues == null) ? 0 : metricValues.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        // CHECKSTYLE:OFF
        if (dimensionRows == null ? that.dimensionRows != null : !dimensionRows.equals(that.dimensionRows)) { return false; }
        if (metricValues == null ? that.metricValues != null : !metricValues.equals(that.metricValues)) { return false; }
        if (timeStamp == null ? that.timeStamp != null : !timeStamp.equals(that.timeStamp)) { return false; }
        // CHECKSTYLE:ON
