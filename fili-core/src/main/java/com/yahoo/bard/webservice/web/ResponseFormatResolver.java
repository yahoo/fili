 ...
 * takes the format name string of URI and a ContainerRequestContext object of which the header Accept field is
 * accessible.
 */
@FunctionalInterface
public interface ResponseFormatResolver extends BiFunction<String, ContainerRequestContext, String> {
    /**
     * Resolve desirable format of URI and ContainerRequestContext.
     *
     * @param format  The format String of URI
