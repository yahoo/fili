...
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.HAVING_ERROR;
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.HAVING_INVALID;
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.HAVING_METRIC_UNDEFINED;
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.HAVING_NON_NUMERIC;
import static com.yahoo.fili.webservice.web.ErrorMessageFormat.HAVING_OPERATOR_INVALID;
...
/**
 * The Fili-level representation of a Druid Having clause. This class assumes that all metrics in the associated
