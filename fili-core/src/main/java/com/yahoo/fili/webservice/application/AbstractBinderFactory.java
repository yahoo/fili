...
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.DRUID_COORDINATOR_METADATA;
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.DRUID_DIMENSIONS_LOADER;
import static com.yahoo.fili.webservice.web.handlers.CacheRequestHandler.CACHE_HITS;
import static com.yahoo.fili.webservice.web.handlers.CacheRequestHandler.CACHE_REQUESTS;
import static com.yahoo.fili.webservice.web.handlers.DefaultWebServiceHandlerSelector.QUERY_REQUEST_TOTAL;
import static com.yahoo.fili.webservice.web.handlers.SplitQueryRequestHandler.SPLITS;
import static com.yahoo.fili.webservice.web.handlers.SplitQueryRequestHandler.SPLIT_QUERIES;

import com.yahoo.fili.webservice.application.healthchecks.AllDimensionsLoadedHealthCheck;
import com.yahoo.fili.webservice.application.healthchecks.DataSourceMetadataLoaderHealthCheck;
import com.yahoo.fili.webservice.application.healthchecks.DruidDimensionsLoaderHealthCheck;
import com.yahoo.fili.webservice.application.healthchecks.VersionHealthCheck;
import com.yahoo.fili.webservice.async.broadcastchannels.BroadcastChannel;
import com.yahoo.fili.webservice.async.broadcastchannels.SimpleBroadcastChannel;
import com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobField;
import com.yahoo.fili.webservice.async.jobs.jobrows.DefaultJobRowBuilder;
import com.yahoo.fili.webservice.async.jobs.jobrows.JobRowBuilder;
import com.yahoo.fili.webservice.async.jobs.payloads.DefaultJobPayloadBuilder;
import com.yahoo.fili.webservice.async.jobs.payloads.JobPayloadBuilder;
import com.yahoo.fili.webservice.async.jobs.stores.ApiJobStore;
import com.yahoo.fili.webservice.async.jobs.stores.NoOpApiJobStore;
import com.yahoo.fili.webservice.async.preresponses.stores.NoOpPreResponseStore;
import com.yahoo.fili.webservice.async.preresponses.stores.PreResponseStore;
import com.yahoo.fili.webservice.async.workflows.AsynchronousWorkflowsBuilder;
import com.yahoo.fili.webservice.async.workflows.DefaultAsynchronousWorkflowsBuilder;
import com.yahoo.fili.webservice.config.FiliFeatureFlag;
import com.yahoo.fili.webservice.config.CacheFeatureFlag;
import com.yahoo.fili.webservice.config.FeatureFlag;
import com.yahoo.fili.webservice.config.FeatureFlagRegistry;
import com.yahoo.fili.webservice.config.SystemConfig;
import com.yahoo.fili.webservice.config.SystemConfigProvider;
import com.yahoo.fili.webservice.data.DruidQueryBuilder;
import com.yahoo.fili.webservice.data.DruidResponseParser;
import com.yahoo.fili.webservice.data.PartialDataHandler;
import com.yahoo.fili.webservice.data.PreResponseDeserializer;
import com.yahoo.fili.webservice.data.cache.DataCache;
import com.yahoo.fili.webservice.data.cache.HashDataCache;
import com.yahoo.fili.webservice.data.cache.MemDataCache;
import com.yahoo.fili.webservice.data.cache.MemTupleDataCache;
import com.yahoo.fili.webservice.data.cache.StubDataCache;
...
import com.yahoo.fili.webservice.data.config.dimension.DimensionLoader;
import com.yahoo.fili.webservice.data.config.dimension.TypeAwareDimensionLoader;
...
import com.yahoo.fili.webservice.data.metric.TemplateDruidQueryMerger;
import com.yahoo.fili.webservice.data.time.GranularityDictionary;
import com.yahoo.fili.webservice.data.time.GranularityParser;
import com.yahoo.fili.webservice.data.time.StandardGranularityParser;
import com.yahoo.fili.webservice.data.volatility.DefaultingVolatileIntervalsService;
import com.yahoo.fili.webservice.data.volatility.VolatileIntervalsService;
import com.yahoo.fili.webservice.druid.client.DruidClientConfigHelper;
import com.yahoo.fili.webservice.druid.client.DruidServiceConfig;
import com.yahoo.fili.webservice.druid.client.DruidWebService;
import com.yahoo.fili.webservice.druid.client.impl.AsyncDruidWebServiceImpl;
import com.yahoo.fili.webservice.druid.client.impl.HeaderNestingJsonBuilderStrategy;
import com.yahoo.fili.webservice.druid.model.query.LookbackQuery;
import com.yahoo.fili.webservice.druid.util.FieldConverterSupplier;
import com.yahoo.fili.webservice.druid.util.FieldConverters;
import com.yahoo.fili.webservice.druid.util.SketchFieldConverter;
import com.yahoo.fili.webservice.metadata.DataSourceMetadataLoader;
...
import com.yahoo.fili.webservice.metadata.RequestedIntervalsFunction;
import com.yahoo.fili.webservice.metadata.SegmentIntervalsHashIdGenerator;
...
import com.yahoo.fili.webservice.table.resolver.DefaultPhysicalTableResolver;
import com.yahoo.fili.webservice.table.resolver.PhysicalTableResolver;
import com.yahoo.fili.webservice.util.DefaultingDictionary;
import com.yahoo.fili.webservice.util.SimplifiedIntervalList;
import com.yahoo.fili.webservice.web.DataApiRequest;
import com.yahoo.fili.webservice.web.DimensionApiRequestMapper;
import com.yahoo.fili.webservice.web.DimensionsApiRequest;
import com.yahoo.fili.webservice.web.FilteredSketchMetricsHelper;
import com.yahoo.fili.webservice.web.JobsApiRequest;
import com.yahoo.fili.webservice.web.MetricsApiRequest;
import com.yahoo.fili.webservice.web.MetricsFilterSetBuilder;
import com.yahoo.fili.webservice.web.NoOpRequestMapper;
import com.yahoo.fili.webservice.web.RequestMapper;
import com.yahoo.fili.webservice.web.SlicesApiRequest;
import com.yahoo.fili.webservice.web.TablesApiRequest;
import com.yahoo.fili.webservice.web.handlers.workflow.DruidWorkflow;
import com.yahoo.fili.webservice.web.handlers.workflow.RequestWorkflowProvider;
import com.yahoo.fili.webservice.web.util.QueryWeightUtil;
...
public abstract class AbstractBinderFactory implements BinderFactory {
    ...
    public final Binder buildBinder() {
        return new AbstractBinder() {
            ...
            protected void configure() {
                ...
                Stream.concat(
                        collectFeatureFlags(FiliFeatureFlag.class).stream(),
                ...
                // Fili currently expects there to be one web service optimized for low latency queries
     ...
     *
     * @return An instance of the interface that allows Fili to talk to an arbitrary key-value store system for storing
     ...
     *
     * @return A BroadcastChannel that allows Fili to talk to other Fili processes, by default returns the
    ...
    /**
     * Creates an object that constructs Druid dimension filters from Fili dimension filters.
    ...
    private DataCache<?> buildLocalSignatureCache() {
        if (FiliFeatureFlag.DRUID_CACHE_V2.isSet()) {
    ...
    private DataCache<?> buildTtlCache() {
        if (FiliFeatureFlag.DRUID_CACHE.isSet()) {
