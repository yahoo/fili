...
import com.yahoo.fili.webservice.MessageFormatter;
...
public enum ErrorMessageFormat implements MessageFormatter {
    ...
    EITHER_ERROR_LEFT_OF_RIGHT(
            "Fili experienced an internal error. Sorry.",
    ...
    MISSING_JOB_ID("Fili experienced an internal error. Sorry.", "Missing id for job row %s"),
