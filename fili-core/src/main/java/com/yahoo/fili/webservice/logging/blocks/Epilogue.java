...
public class Epilogue implements LogInfo {
    ...
    /**
     * The connection between Fili and the client is considered to be closed prematurely if the connection is closed
     * before Fili finishes streaming the results back to the client.
     * <p>
     ...
     *
     * @return True if the connection to the client closed before Fili could finish sending the result back to the
     * client
     */
