...
import com.yahoo.fili.webservice.web.filters.HealthCheckFilter;
import com.yahoo.fili.webservice.web.filters.QueryParameterNormalizationFilter;
import com.yahoo.fili.webservice.web.filters.RateLimitFilter;
import com.yahoo.fili.webservice.web.filters.ResponseCorsFilter;
...
/**
 * The resource configuration for the fili web applications, especially core filters.
 */
public class ResourceConfig extends org.glassfish.jersey.server.ResourceConfig {
    ...
    protected void registerFilters() {
        // Register FiliLoggingFilter
        register(FiliLoggingFilter.class, 1);
