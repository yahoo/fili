...
import com.yahoo.fili.webservice.logging.blocks.Epilogue;
import com.yahoo.fili.webservice.logging.blocks.Preface;
import com.yahoo.fili.webservice.util.CacheLastObserver;
...
@Singleton
@Priority(1)
public class FiliLoggingFilter implements ContainerRequestFilter, ContainerResponseFilter, ClientRequestFilter,
    ClientResponseFilter, WriterInterceptor {

    private static final Logger LOG = LoggerFactory.getLogger(FiliLoggingFilter.class);
    ...
    public void aroundWriteTo(WriterInterceptorContext writerInterceptorContext) throws IOException {
        ...
        try {
            ...
            try {
                ...
                LOG.error("Error finalizing the FiliLoggingFilter output stream wrapper.", e);
            }
        }
    }
