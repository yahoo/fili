...
import static com.yahoo.fili.webservice.config.FiliFeatureFlag.UPDATED_METADATA_COLLECTION_NAMES;
...
import com.yahoo.fili.webservice.logging.blocks.TableRequest;
...
import com.yahoo.fili.webservice.web.TableFullViewProcessor;
import com.yahoo.fili.webservice.web.TableView;
...
@Path("/tables")
@Singleton
public class TablesServlet extends EndpointServlet implements FiliConfigResources {
