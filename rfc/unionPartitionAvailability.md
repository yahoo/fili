...
When ask for data of M in 2017, it is legitimate to expect data from DS1 to be returned. But current behavior is
[return a response with no data and missing interval of 2017 notified to client](https://github.com/yahoo/fili/blob/master/fili-core/src/main/java/com/yahoo/bard/webservice/table/availability/PartitionAvailability.java#L92).
...
### 4th Milestone
Add documentation to give downstream projects an easy-to-read instructions on how to decide and use the 2
