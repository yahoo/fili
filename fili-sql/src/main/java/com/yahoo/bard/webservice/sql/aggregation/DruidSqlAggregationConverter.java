...
/**
 * The default implementation of  mapping of Druid's {@link Aggregation} to a {@link SqlAggregation}.
 */
public class DruidSqlAggregationConverter
    ...
    /**
     * Constructors a map of druid to sql aggregations using {@link #getDefaultDruidToSqlAggregation()}.
     */
    ...
    /**
     * Use the given map for converting of druid to sql aggregations.
     *
     * @param druidToSqlAggregation  The mapping of Druid aggregation name to Sql aggregation type.
     */
    ...
    /**
     * The default mapping of druid to sql aggregations defined by {@link DefaultSqlAggregationType}.
     *
     * @return the mapping of druid aggregation names to sql aggregation types.
     */
    ...
    /**
     * Finds the corresponding {@link SqlAggregation} of a druid aggregation.
     *
     * @param aggregation  The druid aggregation, i.e.
     * {@link com.yahoo.bard.webservice.druid.model.aggregation.LongSumAggregation}.
     * @param apiToFieldMapper  the mapping of api name to field name of the aggregation.
     *
