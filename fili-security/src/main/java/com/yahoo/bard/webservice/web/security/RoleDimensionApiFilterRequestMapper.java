...
public class RoleDimensionApiFilterRequestMapper extends ChainingRequestMapper<DataApiRequest> {
    ...
    private final Map<String, Set<ApiFilter>> roleApiFilters;
    ...
    */
    ...
    /**
     * Verify that, given this user, that at least some whitelisted filters have been collected.
