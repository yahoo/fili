...
-------
### Fixed:
- [Fix: Object references leaking into callbacks](https://github.com/yahoo/fili/issues/1071)
    * Bad asynchrony can cause callbacks to linger in memory.  Clearing closed over data after triggering the callback.

- [Fix: Futures generated by AsycHttpCalls are leaking](https://github.com/yahoo/fili/issues/1074)
