...
/**
 * Factory that supports DoubleMinMaker.
 */
public class DoubleMinMakerFactory implements Factory<MetricMaker> {
    @Override
    public MetricMaker build(String name, LuthierConfigNode configTable, LuthierIndustrialPark resourceFactories) {
        return new DoubleMinMaker(resourceFactories.getMetricDictionary());
    }
}
