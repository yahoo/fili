...
import com.yahoo.bard.webservice.data.config.factories.AggregationAverageMakerFactory;
import com.yahoo.bard.webservice.data.config.factories.ArithmeticMakerFactory;
import com.yahoo.bard.webservice.data.config.factories.CountMakerFactory;
import com.yahoo.bard.webservice.data.config.factories.DefaultLogicalTableGroupFactory;
import com.yahoo.bard.webservice.data.config.factories.DoubleSumMakerFactory;
import com.yahoo.bard.webservice.data.config.factories.KeyValueStoreDimensionFactory;
import com.yahoo.bard.webservice.data.config.factories.LongSumMakerFactory;
import com.yahoo.bard.webservice.data.config.factories.DefaultMetricFactory;
import com.yahoo.bard.webservice.data.config.factories.LuceneSearchProviderFactory;
import com.yahoo.bard.webservice.data.config.factories.MapKeyValueStoreFactory;
import com.yahoo.bard.webservice.data.config.factories.NoOpSearchProviderFactory;
import com.yahoo.bard.webservice.data.config.factories.PermissivePhysicalTableFactory;
import com.yahoo.bard.webservice.data.config.factories.ScanSearchProviderFactory;
import com.yahoo.bard.webservice.data.config.factories.StrictPhysicalTableFactory;
import com.yahoo.bard.webservice.data.config.table.LogicalTableGroup;
