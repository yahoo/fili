...
/**
 * Factory that supports DoubleMaxMaker.
 */
public class DoubleMaxMakerFactory implements Factory<MetricMaker> {
    @Override
    public MetricMaker build(String name, LuthierConfigNode configTable, LuthierIndustrialPark resourceFactories) {
        return new DoubleMaxMaker(resourceFactories.getMetricDictionary());
    }
}
